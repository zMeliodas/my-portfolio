...
const About = () => {
  return (
    <div className="bg-backgroundColor w-full max-h-210 pb-24 overflow-y-auto custom-scroll">
      <div className="flex flex-col justify-center mx-72 items-center gap-2 mt-8">
